...
/**
 * UpperCaseFilter class for ensuring that a request variable is upper case.
 * 
 * @package tmLib
 * @subpackage InputFilters
 * @author Dan Humphrey <dan.humphrey@technomedia.co.uk>
...
class UpperCaseFilter extends BaseFilter{
	...
	/**
     * Constructs the UpperCaseFilter class 
     * @access public
	...
	function process($dataSet) {
		$dataSet->set($this->fieldName, strtoupper($dataSet->get($this->fieldName)));
	}
}
?>